...
def parallel_plots(objectives_df):
    ...
    Generates a parallel coordinates plot based on the given DataFrame.

    Parameters
    ----------
    objectives_df : A pandas dataframe containing
...
def plot_quantities():
    ...
    #creates the folders for (policy/three_policy_simulation/png/...) best_env/hydro/irr
    image_format=['png']
